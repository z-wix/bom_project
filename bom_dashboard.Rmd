...
Explore your favorite chapters of the Book of Mormon and see what words get used the most and the overall sentiment of books and chapters using the 
...
sliderInput(
  "bktop",
  label = "Choose # of top words (book level)",
  min = 5,
  max = 15,
  value = 10,
  step = 1,
...
sliderInput(
  "chptop",
  label = "Choose # of top words (chapter level)",
  min = 5,
  max = 15,
  value = 10,
  step = 1,
...
renderPlot({
  tidy_text %>% 
    ...
    scale_fill_manual(values=c("#A5771D","#1B9E77")) +
    labs(
      title = paste("Overall Sentiment Throughout", input$bk),
    ) +
    theme_tufte() +
    theme(
      axis.title.y = element_blank(),
...
renderPlot({
  tidy_text %>% 
    ...
    scale_fill_manual(values=c("#A5771D","#1B9E77")) +
    labs(
      title = paste("Sentiment in", input$bk, input$chp),
    ) +
    theme_tufte() +
    theme(
      axis.title.y = element_blank(),
